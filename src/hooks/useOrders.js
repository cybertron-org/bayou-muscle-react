...
const normalizeOrder = (order) => ({
  ...
  shippingWeightOz: parseFloat(order?.shipping_weight_oz || 0),
  ...
  shippingRateSource: order?.shipping_rate_source || null,
  ...
  items: Array.isArray(order?.items)
    ? order.items.map((item) => ({
        ...
        unitWeightOz: item?.unit_weight_oz == null ? null : parseFloat(item.unit_weight_oz),
